import { a as apiFetch } from "./client2.js";
import { S as Subscribable, k as pendingThenable, l as resolveEnabled, q as shallowEqualObjects, r as resolveStaleTime, c as noop, t as isServer, u as isValidTimeout, v as timeUntilStale, w as timeoutManager, f as focusManager, x as fetchState, y as replaceData, n as notifyManager, i as hashKey, z as getDefaultState, A as getIsRestoringContext, B as getQueryClientContext } from "./context.js";
...
async function batchCreateTasks(inputs) {
  const results = [];
...
const inboxTasksQuery = () => createQuery({
...
const allTasksQuery = () => createQuery({
  queryKey: ["tasks", "all"],
  queryFn: fetchAllTasks
});
const batchCreateTasksMutation = () => {
  const queryClient = useQueryClient();
  return createMutation(
    {
      mutationFn: (inputs) => batchCreateTasks(inputs),
      onSuccess: () => {
        queryClient.invalidateQueries({ queryKey: ["tasks"] });
      }
    },
...
export {
  createMutation as a,
  createTaskMutation as b,
  createQuery as c,
  updateTaskMutation as d,
  deleteTaskMutation as e,
  batchCreateTasksMutation as f,
  allTasksQuery as g,
  inboxTasksQuery as i,
  useQueryClient as u
};
