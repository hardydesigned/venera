import { a as attributes, j as clsx$1, b as bind_props } from "./index.js";
...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline: "bg-background hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-accent/50 border shadow-xs",
