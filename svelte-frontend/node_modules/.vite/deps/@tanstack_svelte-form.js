import {
  ...
  wrap_snippet
} from "./chunk-QKE3DCJT.js";
import "./chunk-DEX2RCYB.js";
import {
  append,
  comment
} from "./chunk-34PGSFHB.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
  ...
  user_effect,
  user_pre_effect
} from "./chunk-B5ALGTIW.js";
import "./chunk-BVOHH7CU.js";
import "./chunk-3LUZOQLA.js";
import "./chunk-JDBW6IVC.js";
import "./chunk-V5IVLKP4.js";
import "./chunk-PZ5AY32C.js";

// node_modules/.pnpm/@tanstack+store@0.8.1/node_modules/@tanstack/store/dist/esm/scheduler.js
...
// node_modules/.pnpm/@tanstack+store@0.8.1/node_modules/@tanstack/store/dist/esm/types.js
function isUpdaterFunction(updater) {
  return typeof updater === "function";
}

// node_modules/.pnpm/@tanstack+store@0.8.1/node_modules/@tanstack/store/dist/esm/store.js
var Store = class {
...
// node_modules/.pnpm/@tanstack+store@0.8.1/node_modules/@tanstack/store/dist/esm/derived.js
...
// node_modules/.pnpm/@tanstack+devtools-event-client@0.4.0/node_modules/@tanstack/devtools-event-client/dist/esm/plugin.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/EventClient.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/utils.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/ValidationLogic.js
var revalidateLogic = ({
  mode = "submit",
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/standardSchemaValidator.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/metaHelper.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/FormApi.js
...
var FormApi = class {
  ...
  constructor(opts) {
    ...
    this.mount = () => {
      ...
      const { onMount: onMount2 } = this.options.validators || {};
      formEventClient.emit("form-api", {
        id: this._formId,
        state: this.store.state,
        options: this.options
      });
      if (!onMount2) return cleanup;
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/FieldApi.js
var FieldApi = class {
  /**
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/mergeForm.js
...
function mergeForm(baseForm, state2) {
  mutateMergeDeep(baseForm.state, state2);
  return baseForm;
}

// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/formOptions.js
function formOptions(defaultOpts) {
  return defaultOpts;
}

// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/FieldGroupApi.js
...
// node_modules/.pnpm/@tanstack+form-core@1.28.3/node_modules/@tanstack/form-core/dist/esm/transform.js
...
// node_modules/.pnpm/@tanstack+svelte-store@0.9.1_svelte@5.53.0/node_modules/@tanstack/svelte-store/dist/index.svelte.js
function useStore(store, selector = (d) => d, options = {}) {
  const equal = options.equal ?? shallow;
  let slice = tag(state(proxy(selector(store.state))), "slice");
  user_effect(() => {
    const unsub = store.subscribe(() => {
      const data = selector(store.state);
      if (equal(get(slice), data)) {
        return;
      }
      set(slice, data, true);
    });
...
function shallow(objA, objB) {
  ...
  if (strict_equals(typeof objA, "object", false) || strict_equals(objA, null) || strict_equals(typeof objB, "object", false) || strict_equals(objB, null)) {
    return false;
  }
  if (objA instanceof Map && objB instanceof Map) {
    if (strict_equals(objA.size, objB.size, false)) return false;
    for (const [k, v] of objA) {
      if (!objB.has(k) || !Object.is(v, objB.get(k))) return false;
    }
    return true;
  ...
  if (objA instanceof Date && objB instanceof Date) {
    if (strict_equals(objA.getTime(), objB.getTime(), false)) return false;
    return true;
  }
  const keysA = Object.keys(objA);
  if (strict_equals(keysA.length, Object.keys(objB).length, false)) {
    return false;
  }
...
// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/Field.svelte
Field_1[FILENAME] = "node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/Field.svelte";
function createField(opts) {
  const options = opts();
  const api = new FieldApi(options);
  const extendedApi = api;
  extendedApi.Field = Field_default;
  let mounted = false;
  onMount(() => {
...
function Field_1($$anchor, $$props) {
  ...
  let fieldOptions = rest_props($$props, ["$$slots", "$$events", "$$legacy", "children"], "fieldOptions");
  ...
  add_svelte_meta(() => snippet(node, () => $$props.children, () => fieldApi), "render", Field_1, 309, 0);
...
if (import.meta.hot) {
  ...
  import.meta.hot.accept((module) => {
    Field_1[HMR].update(module.default);
  });
}
var Field_default = Field_1;

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/Subscribe.svelte
Subscribe[FILENAME] = "node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/Subscribe.svelte";
function Subscribe($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, Subscribe);
  let selector = prop($$props, "selector", 3, (state2) => state2);
  const value = useStore($$props.store, selector());
  var $$exports = { ...legacy_api() };
  var fragment = comment();
  var node = first_child(fragment);
  add_svelte_meta(() => snippet(node, () => $$props.children, () => value.current), "render", Subscribe, 16, 0);
  append($$anchor, fragment);
  return pop($$exports);
}
if (import.meta.hot) {
  Subscribe = hmr(Subscribe);
  import.meta.hot.accept((module) => {
    Subscribe[HMR].update(module.default);
  });
}
var Subscribe_default = Subscribe;

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/createForm.svelte.js
function createForm(opts) {
  const options = opts?.();
  const api = new FormApi(options);
  const extendedApi = api;
  extendedApi.Field = (internal, props) => Field_default(internal, { ...props, form: api });
  extendedApi.createField = (props) => createField(() => {
    return { ...props(), form: api };
  });
  extendedApi.useStore = (selector) => useStore(api.store, selector);
  extendedApi.Subscribe = (internal, props) => Subscribe_default(internal, { ...props, store: api.store });
  onMount(api.mount);
  user_pre_effect(() => api.update(opts?.()));
  return extendedApi;
}

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/context-keys.js
var fieldContextKey = "__tanstack_field_context_key";
var formContextKey = "__tanstack_form_context_key";

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/AppForm.svelte
AppForm[FILENAME] = "node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/AppForm.svelte";
function AppForm($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, AppForm);
  setContext(formContextKey, $$props.form);
  var $$exports = { ...legacy_api() };
  var fragment = comment();
  var node = first_child(fragment);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", AppForm, 16, 0);
  append($$anchor, fragment);
  return pop($$exports);
}
if (import.meta.hot) {
  AppForm = hmr(AppForm);
  import.meta.hot.accept((module) => {
    AppForm[HMR].update(module.default);
  });
}
var AppForm_default = AppForm;

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/InnerAppField.svelte
InnerAppField[FILENAME] = "node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/InnerAppField.svelte";
function InnerAppField($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, InnerAppField);
  setContext(fieldContextKey, $$props.field);
  var $$exports = { ...legacy_api() };
  var fragment = comment();
  var node = first_child(fragment);
  {
    let $0 = user_derived(() => Object.assign($$props.field, $$props.fieldComponents));
    add_svelte_meta(() => snippet(node, () => $$props.children ?? noop, () => get($0)), "render", InnerAppField, 17, 0);
  }
  append($$anchor, fragment);
  return pop($$exports);
}
if (import.meta.hot) {
  InnerAppField = hmr(InnerAppField);
  import.meta.hot.accept((module) => {
    InnerAppField[HMR].update(module.default);
  });
}
var InnerAppField_default = InnerAppField;

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/AppField.svelte
AppField[FILENAME] = "node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/AppField.svelte";
function AppField($$anchor, $$props) {
  check_target(new.target);
  push($$props, true, AppField);
  var $$exports = { ...legacy_api() };
  var fragment = comment();
  var node = first_child(fragment);
  {
    const children = wrap_snippet(AppField, function($$anchor2, field = noop) {
      validate_snippet_args(...arguments);
      var fragment_1 = comment();
      var node_1 = first_child(fragment_1);
      add_svelte_meta(
        () => InnerAppField_default(node_1, {
          get field() {
            return field();
          },
          get children() {
        ...
        17,
        4,
        { componentTag: "InnerAppField" }
      );
      append($$anchor2, fragment_1);
    });
    add_svelte_meta(
      () => component(node, () => $$props.form.Field, ($$anchor2, form_Field) => {
        form_Field($$anchor2, spread_props(() => $$props.fieldProps, { children, $$slots: { default: true } }));
      }),
      "component",
      AppField,
      15,
      0,
      { componentTag: "form.Field" }
    );
  }
  append($$anchor, fragment);
  return pop($$exports);
...
if (import.meta.hot) {
  AppField = hmr(AppField);
  import.meta.hot.accept((module) => {
    AppField[HMR].update(module.default);
  });
}
var AppField_default = AppField;

// node_modules/.pnpm/@tanstack+svelte-form@1.28.3_svelte@5.53.0/node_modules/@tanstack/svelte-form/dist/createFormCreator.svelte.js
function createFormCreatorContexts() {
...
function createFormCreator({ fieldComponents, formComponents }) {
  function createAppForm(props) {
    const form = createForm(props);
    const AppForm2 = (internal, props2) => {
      return AppForm_default(internal, { ...props2, form });
    };
    const AppField2 = (internal, { children, ...fieldProps }) => AppField_default(internal, { fieldProps, form, fieldComponents, children });
    const extendedForm = Object.assign(form, { AppField: AppField2, AppForm: AppForm2, ...formComponents });
    return extendedForm;
  }
...
//# sourceMappingURL=@tanstack_svelte-form.js.map
